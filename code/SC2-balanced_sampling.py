...
dataset_keys = [
    ...
    "gsd", "latitude", "longitude", "class", "order", "family", "genus",
    "species", "pose", "age", "obscured", "area"]
        ...
        for height_index in range(n_crops_height):
            for width_index in range(n_crops_width):
                ...
                for shape in annotation["shapes"]:
                    ...
                    data["order"].append(label["order"])
                    data["family"].append(label["family"])
                    data["genus"].append(label["genus"])
                    data["species"].append(label["species"])
                    data["pose"].append(pose)
                    data["age"].append(label["age"])
