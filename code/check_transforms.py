...
torch.manual_seed(0)
dir = "../datasets/trial/"
orig_img = Image.open(dir + "0b0d7e276bccfeb277ece105e348398c.jpg")
# orig_img.show()
image = T.RandomRotation(degrees=(0, 360))(orig_img)
image = T.RandomResizedCrop(size = 224, scale = (0.75, 1.25), ratio = (1.0, 1.0))(image)
image = T.transforms.RandomHorizontalFlip(0.5)(image)
image.show()
