...
gap = 100
x = np.linspace(0, background_width - 100, int((background_width - 100)/100))
y = np.linspace(0, background_height - 100, int((background_height - 100)/100))
xv, yv = np.meshgrid(x, y)
points = list(zip(xv.ravel(), yv.ravel()))
positions = random.sample(points, 3)
print(positions)
print(tuple(map(int, positions[0])))
# import math
...
# image = Image.open("datasets/trial/mask/57e1a355d37463eea0703f47682eccca.JPG")
# annotation = json.load(open("datasets/trial/mask/57e1a355d37463eea0703f47682eccca.json"))
...
# # instance.show()
# # background = Image.open("datasets/trial/backgrounds/mud/mud1.jpg")
