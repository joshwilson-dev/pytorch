...
def draw_boxes(image_path, model):
    ...
    visualise = torchvision.utils.draw_bounding_boxes(image = image, boxes = image_boxes, labels = named_labels_with_scores, font = "./models/bird-species-detector/BKANT.TTF", font_size = 20, width=5, colors = colours)
    show(visualise)
...
print(os.getcwd())
model_path = "./models/bird-species-detector/model_final_state_dict.pth"
